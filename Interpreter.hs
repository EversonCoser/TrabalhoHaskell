...
step (Mult (Float f1) (Float f2)) = Float (f1 * f2)
step (Mult (Float f1) (Num n2)) = Float (f1 * fromIntegral n2)
step (Mult (Num n1) (Float f2)) = Float (fromIntegral n1 * f2)
step (Mult (Float f1) e2) = Mult (Float f1) (step e2)
